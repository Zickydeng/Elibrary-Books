...
const SearchPage = () => {
  ...
  const API_BASE_URL = `https://www.googleapis.com/books/v1/volumes`; //so the return data has to match with the book cover data.
  ...
  return (
    <>
      <Header>
        <HeaderContainer>
          <LogoText>Elibrary-Book-Search</LogoText>
          <HeaderSearchForm>
            <BookSearchForm
